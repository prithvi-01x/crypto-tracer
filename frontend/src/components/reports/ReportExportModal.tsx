      ...
      <div className="w-full max-w-4xl max-h-[90vh] flex flex-col rounded-2xl bg-police-900 border border-police-700 shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-bold text-white tracking-wide">Forensic Report & Legal Notice Generator</h3>
              ...
              <p className="text-[11px] text-slate-400">
                ...
                {suspectWallet && <span className="font-mono text-slate-300"> | Suspect: {suspectWallet.slice(0, 10)}...</span>}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div className="space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-white">Admissible Electronic Evidence Package</h4>
            ...
            >
              <div className="space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-white">Record-Production Requisition (VASP)</h4>
                <p className="text-[11px] text-slate-400 leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-police-850/80 border border-police-700/80 space-y-4">
            ...
            {activeTab === 'SECTION_94_BNSS' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs pt-2 border-t border-police-750">
                <div>
                  <label className="text-[10px] text-slate-400 uppercase font-semibold block mb-1">
            ...
            {activeTab === 'EVIDENCE_DOSSIER' && (
              <div className="flex items-center gap-2 pt-2 border-t border-police-750">
                <input
                  ...
                  className="h-4 w-4 rounded border-police-700 bg-police-950 text-blue-600 focus:ring-0 cursor-pointer"
                />
                <label htmlFor="includeGraphSnapshot" className="text-xs text-slate-300 cursor-pointer">
            ...
            <div className="flex items-center justify-end pt-2">
              <button
                ...
                disabled={generating}
                className="px-6 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs transition shadow-lg shadow-blue-500/20 flex items-center gap-2 cursor-pointer disabled:opacity-50"
              >
                {generating ? (
            ...
            <div className="p-4 rounded-xl bg-emerald-950/40 border border-emerald-500/40 shadow-xl space-y-3 animate-in fade-in duration-200">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-white">Report Successfully Generated</h4>
                    <span className="text-[11px] font-mono text-emerald-300">{latestReport.file_name}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-police-800 hover:bg-police-700 text-xs text-slate-200 transition"
                  >
                  ...
                  <a
                    href={getReportDownloadUrl(latestReport.id)}
                    download
                    className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-xs font-bold text-white transition shadow-md shadow-emerald-500/20"
                  >
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-emerald-800/40 text-[11px]">
                <div className="flex items-center gap-2 text-slate-400">
                  <span>Size: <strong className="text-slate-200">{(latestReport.file_size_bytes / 1024).toFixed(1)} KB</strong></span>
                  <span>•</span>
                  <span>Generated: <strong className="text-slate-200">{new Date(latestReport.created_at).toLocaleTimeString()}</strong></span>
                </div>

                {/* SHA-256 Content Hash */}
                <div className="flex items-center gap-1.5 font-mono text-[10px] bg-police-950 px-2.5 py-0.5 rounded border border-police-800 text-slate-400">
          ...
          <div className="space-y-3 pt-2">
            ...
            {loadingReports ? (
              ...
              <div className="p-8 rounded-xl bg-police-850/40 border border-police-750 text-center text-xs text-slate-500">
              ...
              <div className="space-y-2">
                {existingReports.map((r) => (
                  <div
                    key={r.id}
                    className="p-3 rounded-xl bg-police-850 border border-police-700 hover:border-police-600 transition flex items-center justify-between gap-3 text-xs"
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <a
                        ...
                        download
                        className="p-1.5 rounded-lg bg-police-800 hover:bg-police-750 text-slate-300 hover:text-white transition"
                        title="Download PDF"
                      >
