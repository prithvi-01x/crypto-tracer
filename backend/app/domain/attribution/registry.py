    ...
    def _load_seed_vasps(self) -> None:
        ...
        seed_data: List[VASPEntry] = [
            ...
            VASPEntry(
                ...
                chain="TRON",
                address="TTornadoCashTronMockMixer111111111",
                address_type="mixer",
            ...
            VASPEntry(
                ...
                chain="TRON",
                address="TAllbridgeCrossChainGateway1111111",
                address_type="bridge",
            ...
            VASPEntry(
                vasp_id="bttc_bridge_tron",
                entity_name="BTTC Cross-Chain Bridge Gateway",
                chain="TRON",
                address="TBTTCBridgeGatewayTRON222222222222",
                address_type="bridge",
                source="bttc_official_docs",
                verification_status="VERIFIED",
                version=self.VERSION,
                description="BitTorrent Chain multi-token lockbox gateway.",
            ),
        ]
